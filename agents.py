...
class FootballNewsLetterAgents():
    def editor_agent(self):
        return Agent(
            role='Editor',
            goal='Oversee the creation of the football Newsletter',
    ...
    def news_fetcher_agent(self):
        return Agent(
            role='NewsFetcher',
            goal='Fetch the top football news stories for the day',
            backstory="""As a digital sleuth, you scour the internet for the latest and most important developments
            in the world of football, ensuring that our readers are always in the know.""",
    ...
    def news_analyzer_agent(self):
        return Agent(
            ...
            analyses of football news stories, making them accessible and engaging for our audience.""",
            tools=[SearchTools.search_internet],
            verbose=True,
            allow_delegation=True,
        )
